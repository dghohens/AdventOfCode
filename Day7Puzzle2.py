...
we work together." Now, you need to account for multiple people working on steps simultaneously. If multiple steps are
...
for z in fcontent:
    for y in fcontent:
        ...
        next_step = checkord(possiblesteps)[0]
        print(next_step)
